...
Чтобы создать текст, можно использовать команду /gpt, для создания изображений — команду /image, для расшифровки аудио - /audio, для перевода видео на другие языки - /video.
